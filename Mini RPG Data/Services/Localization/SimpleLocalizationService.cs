...
public class SimpleLocalizationService : ILocalizationService
{
    ...
    public string ToolTip_Strength() => 
        ...
        "броскам на урон в ближнем бою, бонус блока, проверки на разбивание предмета.";//"Описание СИЛ и за что она отвечает";
    public string ToolTip_Dexterity() =>
        ...
        "проверкам на обезвреживание ловушек и взлом замков.";//"Описание ЛОВ и за что она отвечает";
